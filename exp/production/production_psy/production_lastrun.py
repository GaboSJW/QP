...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/gabmac/Documents/RU/QP/exp/production/pilot_production_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('stimuli_production.xlsx'),
