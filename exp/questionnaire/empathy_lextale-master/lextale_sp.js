...
function instructions_lextaleRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instructions_lextaleComponents)
...
function practice_lextaleRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practice_lextaleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function check_lextaleRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of check_lextaleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trial_lextaleRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trial_lextaleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function prolific_codeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of prolific_codeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
