...
function exp1_trial_loopLoopBegin(exp1_trial_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    exp1_trial_loop.forEach(function() {
...
function exp2_trial_loopLoopBegin(exp2_trial_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    exp2_trial_loop.forEach(function() {
...
function exp1_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    exp1_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function exp1_trialRoutineBegin(snapshot) {
  return async function () {
    ...
    exp1_trialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function end_exp1_trialRoutineBegin(snapshot) {
  return async function () {
    ...
    end_exp1_trialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function exp1_startRoutineBegin(snapshot) {
  return async function () {
    ...
    exp1_startComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function exp2_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    exp2_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function exp2_trialRoutineBegin(snapshot) {
  return async function () {
    ...
    exp2_trialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function end_exp2_trialRoutineBegin(snapshot) {
  return async function () {
    ...
    end_exp2_trialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function exp2_startRoutineBegin(snapshot) {
  return async function () {
    ...
    exp2_startComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function exp2RoutineBegin(snapshot) {
  return async function () {
    ...
    exp2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function full_endRoutineBegin(snapshot) {
  return async function () {
    ...
    full_endComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
